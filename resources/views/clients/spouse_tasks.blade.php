               ...
               @foreach($all_tasks as $index => $task)
                     ...
                     <tr>
                        ...
                        <td>
                          ...
                          <a href="{{ route('task.spouse.approval', [$task->id, 1]) }}" class="label label-success">Approve</a>

                          <a href="{{ route('task.spouse.approval', [$task->id, 0]) }}" class="label label-danger">Disapprove</a>
                        ...
                        @if(Auth::user()->user_role == 'client')
                          ...
                          {!! Form::open(['route'=>'update.spouse.task', 'files' => true]) !!}
                        ...
                        <td>
                          <a href="{{ route('comment.spouse.tasks', $task->id) }}" class="label label-info">Comment</a>
                        </td>
