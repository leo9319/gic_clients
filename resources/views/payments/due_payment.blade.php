		...
		if (elem.value == 'card') {
			...
			var html = `
						...
						<div class="form-group">
						    ...
						    <input type="text" name="bank_name-#" class="form-control" value="ebl" readonly>
						</div>

						<div class="form-group">
						    <label>Total Amount:</label>
						    <input type="number" class="total form-control" placeholder="Amount paid online" name="total_amount-#" onchange="getTotalAmount(this)" required> 
						</div>
